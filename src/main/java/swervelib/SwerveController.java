...
public class SwerveController
{
      ...
      double maxSpeed)
  {
    ...
    // the joystick is near the center (i. e. has been released), in which case the angle is held at the last valid
    // joystick input (hold position when stick released).
    double angle =
        withinHypotDeadband(headingX, headingY) ? lastAngleScalar : Math.atan2(headingX, headingY);
