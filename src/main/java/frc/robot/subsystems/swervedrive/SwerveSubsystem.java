...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg)
  {
    ...
    // See if I can force HeadingCorrection to work
  ...
  public void updateOdometryFromVision() {
      ...
      if(Math.abs(swerveDrive.getRobotVelocity().omegaRadiansPerSecond) > 4) // if our angular velocity is greater than 720 degrees per second, ignore vision updates
      {
        doRejectUpdate = true;
      }
      if(mt2.tagCount == 0)
