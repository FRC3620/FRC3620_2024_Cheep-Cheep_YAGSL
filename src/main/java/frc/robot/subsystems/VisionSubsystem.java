...
public class VisionSubsystem extends SubsystemBase {
    ...
    Pose2d limelightCurrentPoseBlue;
    Pose2d limelightCurrentPoseRed;
    ...
    public void periodic() {
        ...
        Pose2d limelightCurrentPoseBlue = LimelightHelpers.Results.getBotPose2d_wpiBlue();
        Pose2d limelightCurrentPoseRed = LimelightHelpers.Results.getBotPose2d_wpiRed();
        ...
        if (desiredTarget == null) {
            ...
            if (color.get() == Alliance.Blue) {
                ...
                camDistToSpeakerTag = limelightCurrentPoseBlue.getTranslation().getDistance(blueSpeakerPos)-APRILTAGCAM_FRONT_OFFSET;
                ...
                camDistToSpeakerTag = limelightCurrentPoseRed.getTranslation().getDistance(redSpeakerPos)-APRILTAGCAM_FRONT_OFFSET;
    ...
    @AutoLogOutput (key = "getVisionPoseBlue")
    public Pose2d getPoseBlue(){
        return limelightCurrentPoseBlue;
        
    }
    @AutoLogOutput (key = "getVisionPoseRed")
    public Pose2d getPoseRed(){
        
        return limelightCurrentPoseRed;
